...
| `cry3mn_1783699350027` | `_codex_v1.4.56` | `STUP-S` / `clean_extension` / `THIN_SCALP` TP10, SHORT 2bp post-only | `COMPLETED` / `TP` | `+0.05012 USDC` | 2 | no recovery fill; guard blocked | maker entry 1790.84 and maker full exit 1789.05; reconciliation `OBSERVED_COMPLETE` |