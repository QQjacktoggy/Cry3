...
def test_v132_baseline_snapshot_is_stable_after_config_change():
    active = build_active_sample(_settings(mainnet_partial_exit_pct=0.40, mainnet_mid_exit_pct=0.50, mainnet_trail_giveback_frac=0.25), _sample(), source_type="shadow_sample")
    assert active is not None
    later_baseline = baseline_snapshot(_settings(mainnet_partial_exit_pct=0.70, mainnet_mid_exit_pct=0.50, mainnet_trail_giveback_frac=0.25), active)
    ...
    events = build_outcomes(
        _settings(mainnet_partial_exit_pct=0.70, mainnet_mid_exit_pct=0.50, mainnet_trail_giveback_frac=0.25),
        active,
...
def test_v132_paired_delta_profit_a_runner40_beats_baseline_on_same_path():
    settings = _settings(mainnet_trail_arm_frac=0.7, mainnet_trail_giveback_frac=0.25, mainnet_trail_profit_floor_bp=1.5, mainnet_mid_exit_pct=0.50)
